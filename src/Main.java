...
//		System.out.println(number);
		...
		maluch.getWearedOff();		
		sportsCar.getWearedOff();
		System.out.println(trabant.condition);
		System.out.println(maluch.condition);
		System.out.println(sportsCar.condition);
		

		
		//sportsCar cant drive - why?
